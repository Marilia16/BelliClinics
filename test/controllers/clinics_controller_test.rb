...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference("Clinic.count") do
      post clinics_url, params: { clinic: { cnpj: @clinic.cnpj, name: @clinic.name, user_id: @clinic.user_id } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { cnpj: @clinic.cnpj, name: @clinic.name, user_id: @clinic.user_id } }
